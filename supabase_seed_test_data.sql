...
-- =====================================================
-- This script is UNSAFE for remote Supabase instances.
-- It bypasses Supabase Auth's managed authentication system.
--
-- 🛑 ISSUES WITH THIS SCRIPT:
-- - Direct writes to auth.users (bypasses Supabase Auth)
-- - Wrong password hashing (bcrypt vs argon2id)
-- - No transaction control (can leave half-seeded state)
-- - No production safeguards
-- - Missing auth triggers and auditing
--
-- ✅ USE THESE INSTEAD:
--
-- For LOCAL development:
--   npm run seed:local
--   (uses supabase/seed.sql with proper safeguards)
--
-- For REMOTE/STAGING:
--   npm run seed:remote
--   (uses scripts/seed-remote.ts with Admin API)
--
-- See: docs/SEEDING_GUIDE.md for full documentation
-- =====================================================
--
